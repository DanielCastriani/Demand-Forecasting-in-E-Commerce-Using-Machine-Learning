...
main_routes: List[Route] = [
    ...
    Route(url='/data_summary_page', title='Sumário', app=data_summary_page.layout, show_menu=True, icon='fa-calendar'),

    Route(url='/mean_by_date', title='Média Por Dia', app=mean_by_date.layout, show_menu=True, icon='fa-calendar'),

    Route(
        url='/price_x_external', title='Preço x Dados Externos', app=price_x_ext_data_page.layout, show_menu=True, icon='fa-calendar'),
