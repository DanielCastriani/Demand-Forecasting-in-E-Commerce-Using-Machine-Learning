...
from pages import index, var_correlation, lag_correlation, mean_by_date, report_page,performace_report_page
...
main_routes: List[Route] = [
    ...
    Route(url='/performace_report_page', title='Relatório de Performance', app=performace_report_page.layout, show_menu=True, icon='fa-file-excel'),
]
